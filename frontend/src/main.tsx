...
/**
 * LoginScreen - Inline login form shown when not authenticated
 */
const LoginScreen = () => {
        ...
        <div className="space-y-2">
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-2.5 pr-10 rounded-xl border bg-background text-foreground placeholder:text-muted-foreground transition-all focus:outline-none focus:ring-[0.5px] focus:ring-offset-0 ${
                error ? "border-destructive focus:ring-destructive" : "border-input focus:ring-primary/40 focus:border-primary"
              }`}
              disabled={isLoading}
              autoComplete="off"
              autoFocus
