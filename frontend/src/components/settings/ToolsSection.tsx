					...
					<div className="space-y-2 h-full overflow-y-auto pr-1">
						{filtered.map((tool) => {
							...
							return (
								<div
									key={tool.id}
									className={`flex items-center gap-3 rounded-lg border px-3 py-2 text-sm transition-colors ${selected
								...
								>
									...
									<div className="flex items-center gap-2">
										...
										<button
											...
											className={`p-1.5 rounded transition-colors ${tool.require_approval
