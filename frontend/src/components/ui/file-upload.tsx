      ...
      <div className="flex-shrink-0">
        {isImage ? (
          <div className="size-10 rounded overflow-hidden border bg-background">
            <img
              src={getApiUrl(file.fileData.path)}
              alt={file.file.name}
        ...
        <div className="text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px]">
              {new Date(
                file.fileData.uploadedAt || file.fileData.createdAt,
              ).toLocaleString()}
            </span>
          </div>
        </div>
...
export const FilesList = ({ files, onRemove, className }: FilesListProps) => {
