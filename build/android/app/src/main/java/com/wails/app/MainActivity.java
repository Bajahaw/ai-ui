...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupWebView() {
        ...
        // The UI is served from https://wails.localhost but the app API runs on
        // the loopback HTTP server (http://127.0.0.1:8080), so mixed content
        // must be allowed for fetch/EventSource calls to reach it.
